...
public class PatronPublicationsValidator extends ATAbstractValidator {
	public PatronPublicationsValidator() {
	}
	...
	public ValidationResult validate() {
		...
		PatronPublications modelToValidate = (PatronPublications)objectToValidate;
		ATPropertyValidationSupport support =
				new ATPropertyValidationSupport(modelToValidate, "Patron Publications");

		//Publication title is manditory
		if (ValidationUtils.isBlank(modelToValidate.getPublicationTitle()))
			support.addError("Publication Title", "is mandatory");

		//Publication type is manditory
		if (modelToValidate.getPublicationType() == null)
			support.addError("Publication Type", "is mandatory");
