...
public class DisplayListCellRenderer extends JLabel implements ListCellRenderer {
		...
		boolean cellHasFocus)
	{
		if (value != null) {
			...
			} else if (stringValue.equalsIgnoreCase(LookupList.OTHER_TEXT)) {
				//deal with the fact that the other choice is zOther to insure
				//proper sorting
				this.setText(LookupList.OTHER_TEXT_DISPLAY);
			} else {
				setText(stringValue);
			}
