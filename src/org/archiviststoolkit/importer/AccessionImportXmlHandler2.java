 ...
 */
public class AccessionImportXmlHandler2 extends ImportHandler {
     ...
     */
	public AccessionImportXmlHandler2(ImportOptionsAccessions importOptions) {
		super();
	...
	private void addDateInfo(Accessions accession, String dateExpression, BigInteger bulkDateBegin, BigInteger bulkDateEnd, BigInteger dateBegin, BigInteger dateEnd) throws UnknownLookupListException, InvocationTargetException, IllegalAccessException {
		...
		// do nothing
			...
			ImportUtils.nullSafeSet(newDate, ArchDescriptionDates.PROPERTYNAME_BULK_DATE_BEGIN, bulkDateBegin);
			ImportUtils.nullSafeSet(newDate, ArchDescriptionDates.PROPERTYNAME_BULK_DATE_END, bulkDateEnd);
			ImportUtils.nullSafeSet(newDate, ArchDescriptionDates.PROPERTYNAME_DATE_BEGIN, dateBegin);
			ImportUtils.nullSafeSet(newDate, ArchDescriptionDates.PROPERTYNAME_DATE_END, dateEnd);
	...
	private void addResource(Accessions accession,
		...
		if (resourceId != null) {
			...
			Resources resource;
			if (resourceCreation.equalsIgnoreCase(AccessionImportXmlHandler2.RESOURCE_CREATION_NONE)) {
			...
			if (resourceDao.getNewRecordCreated() && resourceCreation.equalsIgnoreCase(AccessionImportXmlHandler2.RESOURCE_CREATION_FULL))
			{
				try {
	...
	public static Vector<String> getResourceRecordCreationValues() {
		...
		returnVector.add(AccessionImportXmlHandler2.RESOURCE_CREATION_NONE);
		returnVector.add(AccessionImportXmlHandler2.RESOURCE_CREATION_STUB);
		returnVector.add(AccessionImportXmlHandler2.RESOURCE_CREATION_FULL);
		return returnVector;
	}
}