...
//		addTableInfoIfNecessary(clazz);
	...
	public static void initDatabaseTables() {
		...
		ATFieldInfo.addTableInfoIfNecessary(PatronPublications.class);
		...
		ATFieldInfo.addTableInfoIfNecessary(CompletedForms.class);
		ATFieldInfo.addTableInfoIfNecessary(Patrons.class);
  	}
