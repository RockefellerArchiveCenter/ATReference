...
@XmlType(name = "separatedmaterial", namespace = "urn:isbn:1-931666-22-9", propOrder = {
    "head",
...
public class Separatedmaterial {
    ...
    @XmlElements({
        ...
        @XmlElement(name = "archref", namespace = "urn:isbn:1-931666-22-9", type = Archref.class),
        @XmlElement(name = "linkgrp", namespace = "urn:isbn:1-931666-22-9", type = Linkgrp.class),
        ...
        @XmlElement(name = "extref", namespace = "urn:isbn:1-931666-22-9", type = Extref.class),
        ...
        @XmlElement(name = "bibref", namespace = "urn:isbn:1-931666-22-9", type = Bibref.class),
