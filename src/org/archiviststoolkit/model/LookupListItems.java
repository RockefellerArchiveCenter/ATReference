...
public class LookupListItems extends DomainObject {
  ...
  private Boolean editable = true;
	...
	//in conjunction with the ability for a list to allow an other option for lists
	//this allows for terms added on the fly to be marked provisional until someone
	//goes in and ok's them
	@IncludeInApplicationConfiguration
  @ExcludeFromDefaultValues
