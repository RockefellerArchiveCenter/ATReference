...
public class LookupList extends DomainObject {
	...
	public static final String OTHER_TEXT = "zOther...";
	public static final String OTHER_TEXT_DISPLAY = "Other...";

	//add the ability for a list to allow an other option
	public static final String PROPERTYNAME_INCLUDE_OTHER_OPTION = "includeOtherOption";
	...
	public TreeSet<String> getListItemsWithBlankAtTop() {
		...
		//if this list supports an other option then add it at the end of the list
		if (this.getIncludeOtherOption()) {
			set.add("other...");
		}
		return set;
	}
	...
	public TreeSet<LookupListItems> getListItemsWithBlankAtTopObjects() {
		...
		//if this list supports an other option then add it at the end of the list
		if (this.getIncludeOtherOption()) {
			set.add(new LookupListItems(this, OTHER_TEXT));
		}
		return set;
	}
