...
public class Subjects extends DomainObject {
	...
	private Set<PatronVisitsSubjects> patronVisitsSubjects = new HashSet<PatronVisitsSubjects>();
	private Set<PatronPublicationsSubjects> patronPublicationsSubjects = new HashSet<PatronPublicationsSubjects>();
...
//		firePropertyChange(PROPERTYNAME_SUBJECT_SCOPE_NOTE, oldValue, subjectScopeNote);
	...
	public Set<PatronVisitsSubjects> getPatronVisitsSubjects() {
		return patronVisitsSubjects;
	}

	public void setPatronVisitsSubjects(Set<PatronVisitsSubjects> patronVisitsSubjects) {
		this.patronVisitsSubjects = patronVisitsSubjects;
	}
	...
	public Set<PatronPublicationsSubjects> getPatronPublicationsSubjects() {
		return patronPublicationsSubjects;
	}

	public void setPatronPublicationsSubjects(Set<PatronPublicationsSubjects> patronPublicationsSubjects) {
		this.patronPublicationsSubjects = patronPublicationsSubjects;
	}
}
