...
public class QueryEditor extends JDialog {
	...
	public QueryEditor(Dialog owner) {
		super(owner);
	}
     ...
     */
	//Patron-Modification
	//set to protected to be able to extend class
	protected void setDigitalObjectGUIComponentsVisible(boolean visible) {
...
//    private ArrayList fieldValues;
	...
	//todo RAC change
	//remove final to allow for extending
...
//			}
	...
	//Patron-Modification
	//added to be able to extend class
	protected JTabbedPane getTabbedPane1() {
		return tabbedPane1;
	}

	//Patron-Modification
	//added to be able to extend class
	protected JCheckBox getIncludedComponentsCheckBox() {
	...
	public class CriteriaRelationshipPairs {
		...
		//todo RAC change
		//change protected to public to allow for extending
//		protected CriteriaRelationshipPairs(Criterion criterion, String propertyName) {
		public CriteriaRelationshipPairs(Criterion criterion, String propertyName) {
...
//		protected CriteriaRelationshipPairs(Criterion criterion, String propertyName, String humanReadableSearchString) {
		public CriteriaRelationshipPairs(Criterion criterion, String propertyName, String humanReadableSearchString) {
			this.propertyName = propertyName;
...
//		protected CriteriaRelationshipPairs(Criterion criterion, String propertyName, String humanReadableSearchString, String context) {
		public CriteriaRelationshipPairs(Criterion criterion, String propertyName, String humanReadableSearchString, String context) {
			this.propertyName = propertyName;
			this.humanReadableSearchString = humanReadableSearchString;
