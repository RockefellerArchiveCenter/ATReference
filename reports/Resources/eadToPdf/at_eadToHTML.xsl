...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" 
    ...
    <xsl:template name="css">
        <style type="text/css">
            ...
            #toc dt a:link, #toc dd a:link {color: #046; text-decoration: none;} 
            #toc dt a:visited, #toc dd a:visited {color: #046; text-decoration: none;} 
            #toc dt a:active, #toc dd a:active {color: #046;} 
            #toc dt a:hover, #toc dd a:hover {text-decoration:underline;}
            ...
            tr.series{}
            .containerHeader {font-variant: small-caps; font-weight:bold; color:#555;}
